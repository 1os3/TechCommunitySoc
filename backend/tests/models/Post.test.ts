...
describe('Post Model', () => {
  ...
  describe('Post Creation', () => {
    ...
    it('should require title and content', async () => {
      ...
      await expect(Post.create(postDataWithoutTitle as any)).rejects.toThrow();
      ...
      await expect(Post.create(postDataWithoutContent as any)).rejects.toThrow();
    });
  ...
  describe('Static Methods', () => {
    ...
    describe('findActivePostById', () => {
      it('should find active post by id', async () => {
        const found = await Post.findActivePostById(testPost.id);
    ...
    describe('findActivePosts', () => {
      it('should find active posts', async () => {
        const posts = await Post.findActivePosts(10, 0);
      ...
      it('should support pagination', async () => {
        ...
        const firstPage = await Post.findActivePosts(1, 0);
        const secondPage = await Post.findActivePosts(1, 1);
    ...
    describe('findHotPosts', () => {
      it('should find posts ordered by hotness score', async () => {
        const hotPost = await Post.create({
          title: 'Hot Post',
        ...
        const posts = await Post.findHotPosts(10);

...
exports.HotnessSchedulerController = void 0;
const hotnessScheduler_1 = __importDefault(require("../services/hotnessScheduler"));
class HotnessSchedulerController {
    /**
     * 启动热度调度器
     */
    static async startScheduler(req, res) {
        try {
            ...
            const scheduler = hotnessScheduler_1.default.getInstance();
     ...
     * 立即执行热度更新
     */
    static async executeImmediateUpdate(req, res) {
        try {
            const scheduler = hotnessScheduler_1.default.getInstance();
     ...
     * 清理过期帖子
     */
    static async cleanupExpiredPosts(req, res) {
        try {
            const scheduler = hotnessScheduler_1.default.getInstance();
     ...
     * 获取更新统计
     */
    static async getUpdateStatistics(req, res) {
        try {
            const scheduler = hotnessScheduler_1.default.getInstance();
...
exports.HotnessSchedulerController = HotnessSchedulerController;
exports.default = HotnessSchedulerController;
//# sourceMappingURL=hotnessSchedulerController.js.map